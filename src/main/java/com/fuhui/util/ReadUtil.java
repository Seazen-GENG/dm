...
public class ReadUtil {
    ...
    public static void main(String[] args) {
        LOGGER.info("======apk=========");
        String apkUrl = "D:/apk/daoxueben.apk";
        //http://221.130.137.218:81/app/daoxueben.apk
        //String apkUrl = "http://221.130.137.218:81/app/daoxueben.apk";
        Map<String, Object> mapApk = ReadUtil.readAPK(apkUrl);
        for (String key : mapApk.keySet()) {
            LOGGER.info(key + ":" + mapApk.get(key));
        }
    }
}
